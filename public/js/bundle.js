...
function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidnVsZWJhb2xvbmciLCJhIjoiY2xob2thdWpuMWxtZjNmcWwxNmN3OWtnaCJ9.2DxslRthooxypIYy5Y2f1w';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/vulebaolong/clholw4ti01s201qy70mt6h0f',
    // style URL,
    scrollZoom: false
...
function _updateSetting() {
  _updateSetting = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    var url, result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
var stripe = Stripe('pk_test_51N9NTTISr26WeZMuyexznkr7v0Uy02LKk0huuxveC5Kitnhhx4rfBFTbPfDbaClnS1SZVTb0L1hJOVAJlInSIidp00nwXj8p9P');
